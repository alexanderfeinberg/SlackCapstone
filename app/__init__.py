...
app.register_blueprint(channel_message_router,
                       url_prefix='/api/channel-messages')
app.register_blueprint(workspace_router,
...
def react_root(path):
    ...
    """
    if path == 'favicon.ico':
        return app.send_from_directory('public', 'faviconT.png')
