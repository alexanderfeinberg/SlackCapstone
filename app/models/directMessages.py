...
class DirectMessage(db.Model):
    ...
    messages = db.relationship(
        "Messages",  back_populates="direct_message_chat", primaryjoin="and_(Messages.source_type=='directMessages', foreign(Messages.source_id)==DirectMessage.id)", lazy="dynamic", cascade="all, delete")
    ...
    def to_dict(self):
        print("DM USERS ", self.users, [user.to_dict() for user in self.users])
